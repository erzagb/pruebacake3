...
class DistritosTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->primaryKey(['nombre_provincia', 'nombre_canton', 'nombre_distrito']);
    }
    ...
    {
        $validator
            ->allowEmpty('nombre_distrito', 'create');

        $validator
            ->requirePresence('codigo_distrito', 'create')
            ->notEmpty('codigo_distrito');
