	...
	<div class="row">
			<div class="col-md-6 col-md-offset-3">
					...
					<?php echo $this->Form->create(null,['url'=>['controller'=>'Sedes','action'=>'add']]);?>
					<fieldset>
				</div>
...
<div class="col-md-6 col-md-offset-3">
  ...
  <div class="col-md-12">
  <input id="NomSede" name="nombre"  class="form-control input-md" required="" type="text">
    <br>
  </div>
</div>
...
<div class="col-md-7 col-md-offset-3">
  ...
  <div class="col-md-3 col-xs-offset-0">
   <select id="provSede" name="provincia" class="form-control">
   ...
   <div class="col-md-3 col-xs-offset-0">
  <select id="cantSede" name="canton" class="form-control">
          <option value="1">San josé</option>
   ...
   <div class="col-md-3 col-xs-offset-0">
  <select id="distSede" name="distrito" class="form-control">
          <option value="1">Zapote</option>
          <option value="2">B</option>
          <option value="3">C</option>
          <option value="4">D</option>
          <option value="5">E</option>
...
<br>
	...
	<div class="col-md-6 col-md-offset-3">
	  ...
	  <div class="col-md-12">
	 <textarea class="form-control" id="direccion" name="Descripción del curso"></textarea>
		<br>
	  </div>
	  </div>
